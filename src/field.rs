...
impl FieldType {
    pub fn from_tags(record_tag: Tag, field_tag: Tag) -> FieldType {
        match (record_tag, field_tag) {
            ...
            (CLAS, FNAM) => FieldType::String(Left(StringCoerce::None)),
            (CONT, FNAM) => FieldType::String(Left(StringCoerce::None)),
            (MISC, FNAM) => FieldType::String(Left(StringCoerce::None)),
            (PCDT, FNAM) => FieldType::Binary,
            (SPEL, FNAM) => FieldType::String(Left(StringCoerce::None)),
