...
impl FieldType {
    pub fn from_tags(record_tag: Tag, field_tag: Tag) -> FieldType {
        match (record_tag, field_tag) {
            ...
            (BODY, FNAM) => FieldType::StringZ,
            (CLAS, FNAM) => FieldType::StringZ,
            (CONT, FNAM) => FieldType::StringZ,
            (DOOR, FNAM) => FieldType::StringZ,
            (MISC, FNAM) => FieldType::StringZ,
            (NPC_, FNAM) => FieldType::StringZ,
            (PCDT, FNAM) => FieldType::Binary,
            (RACE, FNAM) => FieldType::StringZ,
            (WEAP, FNAM) => FieldType::StringZ,
            ...
            (MISC, ITEX) => FieldType::StringZ,
            (WEAP, ITEX) => FieldType::StringZ,
            ...
            (BODY, MODL) => FieldType::StringZ,
            (CONT, MODL) => FieldType::StringZ,
            (DOOR, MODL) => FieldType::StringZ,
            (LIGH, MODL) => FieldType::StringZ,
            (MISC, MODL) => FieldType::StringZ,
            (STAT, MODL) => FieldType::StringZ,
            (WEAP, MODL) => FieldType::StringZ,
            ...
            (BODY, NAME) => FieldType::StringZ,
            (CELL, NAME) => FieldType::StringZ,
            (CLAS, NAME) => FieldType::StringZ,
            (CONT, NAME) => FieldType::StringZ,
            (DOOR, NAME) => FieldType::StringZ,
            (GLOB, NAME) => FieldType::StringZ,
            (JOUR, NAME) => FieldType::Multiline(StringCoerce::None, LinebreakStyle::Unix), // TODO None need check
            (LIGH, NAME) => FieldType::StringZ,
            (MISC, NAME) => FieldType::StringZ,
            (NPC_, NAME) => FieldType::StringZ,
            (SPLM, NAME) => FieldType::Int,
            (SSCR, NAME) => FieldType::String(Left(StringCoerce::TrimTailZeros)),
            (STAT, NAME) => FieldType::StringZ,
            (WEAP, NAME) => FieldType::StringZ,
