...
impl FieldType {
    pub fn from_tags(record_tag: Tag, field_tag: Tag) -> FieldType {
        match (record_tag, field_tag) {
            ...
            (_, CIDX) => FieldType::I64,
            (CLAS, CLDT) => FieldType::Class,
            (_, CMND) => FieldType::Bool8,
            ...
            (CSTA, POS_) => FieldType::F32List,
            (_, POS_) => FieldType::Position,
            ...
            (_, SPEC) => FieldType::I32List,
            (_, SPEL) => FieldType::String(None),
            (_, STAR) => FieldType::Time,
            ...
            (_, WWAT) => FieldType::Attributes,
            (_, WWSK) => FieldType::Skills,
