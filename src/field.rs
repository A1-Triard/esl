...
impl FieldType {
    pub fn from_tags(record_tag: Tag, field_tag: Tag) -> FieldType {
        match (record_tag, field_tag) {
            ...
            (TES3, GMDT) => FieldType::Compressed,
            ...
            (TES3, SCRD) => FieldType::Compressed,
            (_, SCRI) => FieldType::StringZ,
            (TES3, SCRS) => FieldType::Compressed,
            ...
            (_, SLFD) => FieldType::Floats,
            (_, SLLD) => FieldType::Ints,
            (_, SLSD) => FieldType::Shorts,
